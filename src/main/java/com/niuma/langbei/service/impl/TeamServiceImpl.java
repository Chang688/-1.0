...
import com.niuma.langbei.mapper.TeamMapper;
...
import com.niuma.langbei.model.enums.TeamStatusEnum;
...
public class TeamServiceImpl extends ServiceImpl<TeamMapper, Team>
    ...
    public Boolean joinTeam(TeamJoinRequest teamJoinRequest, User loginUser) {
        ...
        if(loginUser.getGender()==1){
            throw new BusinessException(ErrorCode.PARAMS_ERROR, "只有女生能加入！");
        }
    ...
    public Boolean deleteTeam(Long id, User loginUser) {
        ...
        //2.校验身份
        if (team.getUserId() != loginUser.getId() || loginUser.getUserRole() == 1) {
